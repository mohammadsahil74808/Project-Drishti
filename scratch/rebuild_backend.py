...
MAPPING = {
    ...
    r"from app\.models\.fir import (.*)": r"from app.schemas.crime_type import CrimeType\nfrom database.models.fir import \1",
...
def process_file(filepath):
    ...
    new_content = new_content.replace(
        "from app.schemas.crime_type import CrimeType\nfrom database.models.fir import CrimeType, CaseStatus",
        "from app.schemas.crime_type import CrimeType\nfrom database.models.fir import CaseStatus"
    ).replace(
        "from app.schemas.crime_type import CrimeType\nfrom database.models.fir import CaseStatus, CrimeType",
        "from app.schemas.crime_type import CrimeType\nfrom database.models.fir import CaseStatus"
    ).replace(
        "from app.schemas.crime_type import CrimeType\nfrom database.models.fir import CrimeType, FIR",
        "from app.schemas.crime_type import CrimeType\nfrom database.models.fir import FIR"
    ).replace(
        "from app.schemas.crime_type import CrimeType\nfrom database.models.fir import CrimeType",
        "from app.schemas.crime_type import CrimeType"
    )
